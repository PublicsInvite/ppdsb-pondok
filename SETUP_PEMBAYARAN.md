...
### 5. **User Upload Bukti Pembayaran**
   ...
   - Dapat nomor pembayaran: **PAY-YYYYMMDD-XXXXX**
...
nomor_pembayaran        | VARCHAR(50)    | PAY-YYYYMMDD-XXXXX (unique)
...
nomor_rekening          | VARCHAR(50)    | Rekening pengirim
nama_rekening           | VARCHAR(255)   | Nama pemilik rekening pengirim
...
```json
{
  ...
  "catatan": "Transfer via mobile banking"
}
```
...
6. **Form**: Input nomor rekening dan nama pengirim
7. **Preview**: Tampil preview gambar bukti transfer
